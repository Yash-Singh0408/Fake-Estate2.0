        ...
        {(post) => (
          ...
          >
            <motion.div className="details" variants={fadeInUp(0)}>
              <div className="wrapper">
                ...
                <motion.div className="info" variants={fadeInUp(0.2)}>
                  <div className="top">
                    <div className="post">
                      <motion.h1 variants={fadeInUp(0.3)}>{post.title}</motion.h1>
                      <motion.div className="address" variants={fadeInUp(0.35)}>
            ...
            <motion.div className="features" variants={fadeInUp(0.6)}>
              <div className="wrapper">
                <motion.p className="title" variants={fadeInUp(0.65)}>Location</motion.p>
                ...
                <motion.p className="title" variants={fadeInUp(0.8)}>General</motion.p>
                <motion.div className="listVertical" variants={fadeInUp(0.85)}>
                ...
                <motion.p className="title" variants={fadeInUp(0.9)}>Sizes</motion.p>
                ...
                <motion.p className="title" variants={fadeInUp(1)}>Nearby Places</motion.p>
                <motion.div className="listHorizonatal" variants={fadeInUp(1.05)}>
                  <div className="feature">
